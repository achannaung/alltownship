  ...
  return (
    <div id="filter-card" className="glass-panel rounded-2xl p-6 shadow-2xl mb-8 relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold tracking-tight text-white font-serif">Search & Filter Parameters</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="township-input" className="text-sm font-medium text-slate-300">
            Township Name (English or Burmese):
          </label>
          <div className="relative">
            <input
              ...
              placeholder="e.g. Taikkyi, Kalaw, လှည်းကူး"
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <input
              ...
              onKeyDown={handleKeyDown}
              placeholder="e.g. ရွာမ, Ywa Thit, ကုန်းကြီး"
              className="w-full glass-input rounded-xl pl-4 pr-10 py-3 text-white placeholder-slate-500"
            />
            {villageQuery && (
              <button
      ...
      <div className="mt-6 pt-5 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button
            ...
            type="button"
            onClick={onClear}
            className="flex-1 sm:flex-none border border-slate-700 hover:border-slate-500 hover:bg-white/5 active:bg-white/10 text-slate-300 font-medium py-3 px-6 rounded-xl transition duration-150 flex items-center justify-center gap-2 cursor-pointer"
          >
            <X size={18} />
            <span>Clear</span>
          </button>
          ...
          <button
            ...
            type="button"
            onClick={onSearch}
            className="flex-1 sm:flex-none bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white font-medium py-3 px-8 rounded-xl transition duration-150 shadow-lg shadow-indigo-600/30 hover:shadow-indigo-500/40 flex items-center justify-center gap-2 cursor-pointer"
          >
            <Search size={18} />
            <span>Search</span>
          </button>
